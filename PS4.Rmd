...
c) Distance seems to have a negative significant effect on the probability of switching. This result is consistent with our expectations as suggests that the larger the distance between respondent's location and a healthy well has a negative effect on the probability that that family changes its selected well.
